        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h2>View Customer Payment History</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="products call-to-action">
     ...
     <!--Table-->
            ...
            <tr>
                ...
                <th style='width:10%'><h4><strong>Id</strong></h3></th>
                <th style='width:10%'><h4><strong>ISBN</strong></h3></th>
                <th style='width:10%'><h4><strong>Quantity</strong></h3></th>
                <th style='width:10%'><h4><strong>Postage</strong></h3></th>
                <th style='width:10%'><h4><strong>Total</strong></h3></th>
                <th style='width:40%'><h4><strong>Address</strong></h3></th>
            </tr>
